import type { MigrationImage, MigrationLinkToMedia, MigrationRTImageNode } from "../types/migration/Asset.js";
import type { MigrationContentRelationship } from "../types/migration/ContentRelationship.js";
import { type InjectMigrationSpecificTypes } from "../types/migration/Document.js";
import type { PrismicDocument } from "../types/value/document.js";
import type { GroupField } from "../types/value/group.js";
import type { OptionalLinkProperties } from "../types/value/link.js";
import type { SliceZone } from "../types/value/sliceZone.js";
import type { AnyRegularField } from "../types/value/types.js";
/**
 ...
 */
export declare const contentRelationship: (value: UnknownValue) => value is MigrationContentRelationship & OptionalLinkProperties;
/**
 ...
 * This is not an official helper function and it's only designed to work with internal processes.
 */
export declare const image: (value: UnknownValue) => value is MigrationImage;
/**
 ...
 * This is not an official helper function and it's only designed to work with internal processes.
 */
export declare const linkToMedia: (value: UnknownValue) => value is MigrationLinkToMedia & OptionalLinkProperties;
/**
 ...
 * This is not an official helper function and it's only designed to work with internal processes.
 */
export declare const rtImageNode: (value: UnknownValue) => value is MigrationRTImageNode;
export {};
