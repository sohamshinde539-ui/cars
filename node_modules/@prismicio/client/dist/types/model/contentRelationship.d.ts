import type { CustomTypeModelFieldType } from "./types.js";
import type { CustomTypeModelLinkSelectType } from "./link.js";
/**
 * @internal
 */
 ...
 */
export interface CustomTypeModelContentRelationshipField<CustomTypes extends string | CustomTypeModelFetchCustomTypeLevel1 = string | CustomTypeModelFetchCustomTypeLevel1, Tags extends string = string> {
