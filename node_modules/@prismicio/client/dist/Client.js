...
class Client {
  ...
  async getRepository(params) {
    ...
    switch (response.status) {
      ...
      case 404: {
        throw new RepositoryNotFoundError(`Prismic repository not found. Check that "${this.documentAPIEndpoint}" is pointing to the correct repository.`, url.toString(), void 0);
      }
      default: {
        throw new PrismicError(void 0, url.toString(), await response.text());
      }
    }
  }
  /**
  ...
  async _get(params, attemptCount = 0) {
    ...
    try {
      ...
      throttledLog(`[@prismicio/client] The ref (${badRef}) was ${issue}. Now retrying with the latest master ref (${masterRef}). If you were previewing content, the response will not include draft content.`, { level: "warn" });
